...
async function search() {
  ...
  const response = await fetch(
    ...
    console.error("Search Error:", error), search();
  });
  ...
  const searchId = await fetch(`https://app-whfampdoga-uc.a.run.app/${data}`, {
    ...
    console.error("DDF Search Error:", error), search();
  });
  ...
  try {
    ...
    const filterOtherPhotos = dataBase[0].Photo.PropertyPhoto.map(
      (photos) => photos.LargePhotoURL
    ); // filter LargePhotoUrl out of larger object, to minimize size of data rendered on the website
...
////////////////////////////////////////////////////////////////
//////////////////// Logout of RETS Server //////////////////////
////////////////////////////////////////////////////////////////

// Logout of RETS server to sever the connection, DDF REQUIRED

const logoutUrl = "https://app-whfampdoga-uc.a.run.app/logout";
